	...
	if (topLevelMenuIndex == MenuFile) // File
	{
		if (!isRestricted())
		{
			...
			if (!JUCEApplication::isStandaloneApp())
			{
				...
				//exportMenu.addCommandItem(commandManager, doExportFileInstanceVst3); /* uncomment to show in Menu!*/
				exportMenu.addCommandItem(commandManager, doExportFileInstanceRestrictedVst3);
			}
